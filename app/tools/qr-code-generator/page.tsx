...
import { ArrowLeft, QrCode, Download, Settings, Trash2, Eye, Home } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50 font-sans p-4 sm:p-8">
      <div className="max-w-6xl mx-auto space-y-6 py-12">
        <header className="flex flex-col gap-4 border-b border-slate-200 pb-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-teal-600 transition-colors px-3 py-1.5 rounded-lg hover:bg-slate-50"
          >
        ...
        <p className="text-center text-slate-400 text-sm">Powered by qrcode.react.</p>
    </div>
  );
}
